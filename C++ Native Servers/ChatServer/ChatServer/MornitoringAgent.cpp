...
CMornitoringAgent::CMornitoringAgent(CChatServer& Server, WORD ServerNo, const array<BYTE, 32>& LoginSessionKey)
...
{
	SYSLOG(L"MORNI", LOG_ERROR, L"ErrorCode : %d, Message : %s", errorcode, msg);
}
